...
from ASV_prepare import prepare_asv_spoof
...
class SpkIdBrain(sb.Brain):
    ...
    def prepare_features(self, wavs, stage):
        ...
        # CQCC, LogP_absCQT, TimeVec, FreqVec, Ures_LogP_absCQT, Ures_FreqVec, absCQT = cqcc(wavs, fs, B, fmax, fmin, d, cf,ZsdD)
        # CQCC = CQCC.T
        # print(CQCC.shape)
        # feats = self.modules.mean_var_norm(CQCC, lens)
    ...
    def on_stage_start(self, stage, epoch=None):
        ...
        # )
        self.loss_metric = sb.utils.metric_stats.BinaryMetricStats()
    ...
    def on_stage_end(self, stage, stage_loss, epoch=None):
        ...
        # Summarize the statistics from the stage for record-keeping.
            ...
            stats = {
                "loss": stage_loss,
                "error": self.error_metrics.summarize(field="DER"),
            }
...
def dataio_prep(hparams):
    ...
    @sb.utils.data_pipeline.takes("type")
    @sb.utils.data_pipeline.provides("type", "type_encoded")
    def label_pipeline(type):
        yield type
        type_encoded = label_encoder.encode_label_torch(type)
        yield type_encoded
    ...
    for dataset in ["train", "dev", "eval"]:
        datasets[dataset] = sb.dataio.dataset.DynamicItemDataset.from_json(
            ...
            output_keys=["id", "sig", "type_encoded"],
        )
...
if __name__ == "__main__":
    ...
    sb.utils.distributed.run_on_main(
        ...
        kwargs={
            ...
            "save_json_dev": hparams["dev_annotation"],
            "save_json_eval": hparams["eval_annotation"],
        },
    )

    # Create dataset objects "train", "dev", and "eval".
